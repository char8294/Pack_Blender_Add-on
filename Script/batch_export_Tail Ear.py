...
- Apply Scale ทุก object ใน scene (ก่อน export)
- Export setting: Apply Scalings = 'FBX All'
"""
...
# ─── CONFIG ──────────────────────────────────────────────────────────────────
INPUT_DIR  = r"C:\Users\Smart Office\Desktop\Plugin\Python\Tail and Ear_Fix_BatchExport\Input"
OUTPUT_DIR = r"C:\Users\Smart Office\Desktop\Plugin\Python\Tail and Ear_Fix_BatchExport\Output"
# ─────────────────────────────────────────────────────────────────────────────
...
def apply_scale():
    """Apply Scale ให้ทุก object ใน scene"""
    # เลือกทุก object
    for obj in bpy.data.objects:
        obj.select_set(True)
    
    # ถ้ามี object ถูกเลือก ให้ apply scale
    if bpy.context.selected_objects:
        bpy.ops.object.transform_apply(location=False, rotation=False, scale=True)
        print("  ✅ Apply Scale สำเร็จ")
...
def main():
    ...
    for i, input_path in enumerate(fbx_files, 1):
        ...
        try:
            ...
            # Export — default settings + add_leaf_bones=False + Apply Scalings FBX All
